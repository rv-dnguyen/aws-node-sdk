...
module.exports = {
  createCloudfront(name, data){
    return new Promise((resolve, reject) => {
      let params = {
        DistributionConfig: { /* required */
          CallerReference: Date.now().toString(), /* required */
          Comment: data.FunctionName, /* required */
              ...
              Items: [
                {
                  ...
                  LambdaFunctionARN: data.FunctionArn + ':' + data.Version, /* required */
                  IncludeBody: false
                },
                {
          ...
          Origins: { /* required */
            ...
            Items: [
              {
                DomainName: name + '.s3.amazonaws.com', /* required */
                Id: name, /* required */
                // CustomHeaders: {
                //   Quantity: 0, /* required */
                //   Items: [
